      ...
      <div className='flex-1 px-6 py-20'>
        <div className='max-w-6xl mx-auto'>
          ...
          <div className='flex justify-center mb-6'>
            <div className='bg-cyan-100 text-gray-700 text-sm px-4 py-2 rounded-full flex items-center gap-2'>
              <HiSparkles size={16} className="bg-red-50 text-red-600" />
          ...
          <div className='text-center mb-28'>
            ...
            <div className='flex flex-wrap justify-center gap-4 mt-10'>
              <motion.button
                ...
                className='bg-purple-800 text-white px-10 py-3 rounded-full hover:opacity-90 transition shadow-md'>
                Start Interview
              ...
              <motion.button
                ...
                whileHover={{ opacity: 0.9, scale: 1.03 }}
                whileTap={{ opacity: 1, scale: 0.98 }}
                className='border border-cyan-300 px-10 py-3 rounded-full hover:bg-cyan-100 transition'>
                View History
